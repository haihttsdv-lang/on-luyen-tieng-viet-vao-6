...
export const ALL_PASSAGES: Passage[] = [
  {
    ...
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-02",
  ...
  {
    id: "dh-passage-16",
    title: "Người lái đò trên sông",
    text: "Ở bến sông đầu làng, đã hơn hai mươi năm nay, bác Tám vẫn ngày ngày chèo đò đưa khách qua sông. Chiếc đò gỗ cũ kỹ nhưng luôn được bác giữ gìn sạch sẽ, chắc chắn. Ai trong làng cũng quý mến bác vì tính tình hiền hậu, sẵn sàng giúp đỡ mọi người dù trời nắng hay mưa.\n\nMột buổi tối mưa gió, khi bác Tám vừa định nghỉ ngơi thì nghe tiếng gọi thất thanh từ bờ bên kia. Đó là chú Sáu, tất tưởi xin bác chèo đò gấp vì con trai chú đang sốt cao, cần đưa đi trạm y tế bên này sông. Không ngần ngại, bác Tám khoác vội chiếc áo mưa, ra sức chèo đò vượt qua dòng nước đang chảy xiết vì mưa lớn.\n\nSuốt chặng đường, bác vừa chèo vừa trấn an chú Sáu đang lo lắng. Nhờ chuyến đò đêm ấy, con trai chú Sáu được đưa đến trạm y tế kịp thời và qua cơn nguy hiểm. Khi chú Sáu ngỏ ý gửi tiền cảm ơn, bác Tám chỉ cười xua tay: \"Cứu người lúc hoạn nạn là chuyện nên làm, tôi không nhận tiền đâu.\" Câu chuyện về bác lái đò tốt bụng được người dân trong làng truyền tai nhau mãi, ai cũng cảm phục tấm lòng nhân hậu của bác.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    ...
    text: "Trong ngăn tủ của bố, Long tình cờ tìm thấy một chiếc đồng hồ đeo tay cũ kỹ, mặt kính đã mờ, dây đeo sờn cũ. Tò mò, Long mang chiếc đồng hồ hỏi bố. Bố trầm ngâm một lúc rồi kể, đây là chiếc đồng hồ duy nhất mà ông nội để lại trước khi qua đời, từng theo ông suốt những năm tháng làm việc vất vả để nuôi các con ăn học.\n\nNghe bố kể, Long xin phép được sửa lại chiếc đồng hồ để có thể đeo nó. Bố đồng ý nhưng dặn dò Long phải giữ gìn cẩn thận. Long mang đồng hồ đến một tiệm sửa chữa quen thuộc trong xóm, nhờ bác thợ lau chùi, thay dây mới. Khi nhận lại chiếc đồng hồ đã chạy đều trở lại, Long cảm thấy vô cùng xúc động, như thể mình đang được kết nối với người ông mà cậu chưa từng có cơ hội gặp mặt.\n\nTừ đó, Long luôn đeo chiếc đồng hồ ấy mỗi ngày, không phải vì nó đẹp hay hiện đại, mà vì nó nhắc cậu nhớ đến những vất vả mà ông nội đã trải qua để xây dựng nên gia đình hạnh phúc hôm nay. Long tự nhủ sẽ cố gắng học tập thật tốt, để xứng đáng với những hy sinh thầm lặng của ông.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-18",
    title: "Vì sao chúng ta cần uống đủ nước",
    text: "Nước chiếm khoảng 70% trọng lượng cơ thể con người và đóng vai trò vô cùng quan trọng đối với hầu hết các hoạt động sống. Các bác sĩ khuyến nghị trẻ em nên uống đủ từ một lít đến một lít rưỡi nước mỗi ngày, tuỳ theo độ tuổi và mức độ vận động.\n\nNước giúp vận chuyển chất dinh dưỡng và ô-xi đến các tế bào trong cơ thể, đồng thời đào thải các chất cặn bã ra ngoài qua đường mồ hôi và nước tiểu. Ngoài ra, nước còn giúp điều hoà thân nhiệt, đặc biệt quan trọng vào những ngày thời tiết nóng bức hoặc khi vận động mạnh, cơ thể ra nhiều mồ hôi.\n\nKhi cơ thể không được cung cấp đủ nước, chúng ta có thể gặp phải tình trạng mất nước với các biểu hiện như khô miệng, mệt mỏi, đau đầu, khó tập trung, thậm chí chóng mặt nếu tình trạng kéo dài. Vì vậy, thay vì đợi đến khi cảm thấy khát mới uống nước, các em nên tập thói quen uống nước đều đặn trong ngày, đặc biệt là sau khi vận động hoặc chơi thể thao, để cơ thể luôn khoẻ mạnh và tràn đầy năng lượng.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-19",
    title: "Cuộc phiêu lưu trong thư viện",
    text: "Vy vốn không thích đọc sách, mỗi lần đến thư viện trường chỉ để ngồi cho hết giờ theo yêu cầu của cô giáo. Một hôm, khi đang lơ đãng lướt qua các kệ sách, Vy vô tình làm rơi một cuốn sách cũ có bìa vẽ hình một khu rừng bí ẩn. Tò mò, Vy nhặt lên và đọc thử vài trang đầu.\n\nCàng đọc, Vy càng bị cuốn vào câu chuyện về một nhóm bạn nhỏ phiêu lưu tìm kho báu trong khu rừng kỳ lạ, vượt qua bao thử thách hồi hộp. Vy quên mất thời gian, đọc một mạch đến hết buổi mà không hay biết. Khi tiếng chuông báo hết giờ vang lên, Vy ngỡ ngàng nhận ra mình đã đọc hết một phần ba cuốn sách dày mà không hề thấy chán như mọi khi.\n\nTừ hôm đó, Vy bắt đầu mượn sách về nhà đọc mỗi tối, dần dần khám phá ra nhiều thể loại sách thú vị khác nhau, từ truyện phiêu lưu đến sách khoa học. Vy nhận ra rằng thư viện không hề nhàm chán như mình từng nghĩ, mà giống như một cánh cửa mở ra vô vàn thế giới kỳ diệu, chỉ cần mình chịu khó bước vào khám phá.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-20",
    title: "Bạn đồng hành trên đường đến trường",
    text: "Sáng hôm ấy, trời mưa to bất ngờ khiến con đường đất dẫn vào xóm của Tân ngập nước, bùn lầy trơn trượt. Xe đạp của Tân đi được nửa đường thì bị sa lầy, bánh xe quay tít mà không nhích lên được. Tân loay hoay mãi vẫn không đẩy được xe qua đoạn lầy, trong khi giờ vào học đã sắp đến.\n\nĐúng lúc đó, Hải — bạn cùng xóm học chung lớp — đạp xe ngang qua, thấy vậy liền dừng lại giúp đỡ. Hai bạn cùng nhau xắn quần lội xuống bùn, người đẩy, người kéo, cuối cùng cũng đưa được xe của Tân qua khỏi đoạn đường lầy lội. Cả hai đều lấm lem bùn đất nhưng không ai than phiền, chỉ cười với nhau rồi cùng đạp xe thật nhanh đến trường.\n\nHôm đó, dù đến lớp trễ vài phút và bị cô giáo nhắc nhở, nhưng Tân không hề buồn, ngược lại còn thấy vui vì có một người bạn tốt luôn sẵn sàng giúp đỡ mình lúc khó khăn. Từ đó, tình bạn giữa Tân và Hải càng thêm gắn bó, cả hai thường xuyên đạp xe đi học cùng nhau, cùng nhau vượt qua những đoạn đường khó đi mỗi khi trời mưa.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-21",
    title: "Loài ong và công việc thụ phấn",
    text: "Ong không chỉ là loài vật cho chúng ta mật ngọt mà còn đóng vai trò cực kỳ quan trọng trong tự nhiên với công việc thụ phấn cho hoa. Khi ong bay từ bông hoa này sang bông hoa khác để hút mật, những hạt phấn hoa nhỏ li ti sẽ dính vào lông trên cơ thể ong và được mang theo đến những bông hoa tiếp theo.\n\nNhờ quá trình này, phấn hoa từ nhị hoa (bộ phận sinh sản đực) được chuyển đến nhuỵ hoa (bộ phận sinh sản cái) của một bông hoa khác, giúp cây có thể kết trái, tạo ra hạt giống cho thế hệ cây tiếp theo. Các nhà khoa học ước tính có đến hơn một phần ba lượng thực phẩm mà con người tiêu thụ mỗi ngày, như các loại trái cây, rau củ, đều phụ thuộc một phần vào quá trình thụ phấn của ong và các loài côn trùng khác.\n\nĐáng tiếc, trong những năm gần đây, số lượng ong trên thế giới đang suy giảm đáng kể do việc sử dụng thuốc trừ sâu quá mức, mất môi trường sống tự nhiên và biến đổi khí hậu. Nếu loài ong biến mất, không chỉ ngành nông nghiệp bị ảnh hưởng nặng nề mà cả hệ sinh thái tự nhiên cũng có thể mất cân bằng nghiêm trọng. Vì vậy, việc bảo vệ loài ong đang trở thành một vấn đề môi trường được nhiều quốc gia quan tâm.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-22",
    title: "Chiếc bánh trung thu đầu tiên",
    text: "Năm nay, thay vì mua bánh trung thu như mọi năm, mẹ quyết định cả nhà sẽ cùng nhau tự làm bánh. Bé Su háo hức lắm vì đây là lần đầu tiên cô được tự tay làm bánh trung thu cùng mẹ và chị Hai. Mẹ chuẩn bị sẵn bột, nhân đậu xanh, khuôn bánh hình hoa và hình cá chép truyền thống.\n\nBan đầu, Su nặn bột vụng về, chiếc bánh đầu tiên méo mó, nhân bị lộ ra ngoài trông không được đẹp mắt. Su hơi buồn, định bỏ cuộc, nhưng chị Hai động viên: \"Không sao đâu, ai làm lần đầu chẳng vụng về, cứ thử lại vài lần nữa xem.\" Được chị hướng dẫn cách vo bột đều tay và ém nhân kỹ hơn, những chiếc bánh sau của Su dần đẹp hơn hẳn.\n\nTối hôm đó, cả nhà quây quần bên mâm bánh tự làm, cùng nhau thưởng thức dưới ánh trăng rằm. Dù hình dáng bánh không hoàn hảo như bánh mua ngoài tiệm, nhưng ai cũng khen ngon và ấm áp hơn hẳn. Su cảm thấy tự hào vì chiếc bánh trung thu đầu tiên do chính tay mình làm ra, và Tết Trung thu năm ấy trở thành một trong những kỷ niệm đáng nhớ nhất mà cô sẽ không bao giờ quên.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-23",
    title: "Bài học từ trận thua bóng đá",
    text: "Đội bóng của lớp 5B do Duy làm đội trưởng đã lọt vào trận chung kết giải bóng đá học sinh toàn trường. Suốt cả tháng, cả đội miệt mài tập luyện mỗi buổi chiều, ai cũng tin rằng năm nay đội sẽ giành được chức vô địch đầu tiên.\n\nTuy nhiên, trong trận chung kết, dù chơi rất nỗ lực nhưng đội của Duy vẫn để thua đối thủ với tỷ số sít sao 2-1, khi cơ hội gỡ hoà cuối cùng bị bỏ lỡ đáng tiếc. Cả đội buồn bã, một vài bạn còn bật khóc ngay trên sân vì tiếc nuối. Duy cũng rất thất vọng nhưng cố kìm nén cảm xúc để động viên đồng đội.\n\nTối hôm đó, thầy giáo chủ nhiệm gọi cả đội lại, nói rằng: \"Thua một trận đấu không có nghĩa là các em thất bại, quan trọng là các em đã cùng nhau cố gắng hết mình và đoàn kết suốt cả mùa giải.\" Nghe thầy nói, Duy và các bạn dần nguôi ngoai, nhận ra rằng tinh thần thể thao và sự nỗ lực hết mình mới là điều đáng quý nhất, không nhất thiết phải chiến thắng mới là thành công. Cả đội hẹn nhau mùa giải sau sẽ tiếp tục cố gắng nhiều hơn nữa.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-24",
    title: "Cụ già bán bánh mì",
    text: "Ở góc phố gần trường, có một cụ già bán bánh mì đã ngồi đó từ khi Nghĩa còn học lớp một. Chiếc xe bánh mì cũ kỹ của cụ luôn được lau chùi sạch sẽ, dù trời nắng hay mưa cụ vẫn kiên trì ngồi bán từ sáng sớm đến tận trưa. Nhiều bạn học sinh thường nói rằng bánh mì của cụ tuy giản dị nhưng luôn nóng hổi và đậm đà.\n\nMột hôm, Nghĩa vô tình nghe cụ kể chuyện với một người khách quen rằng cụ đã bán bánh mì suốt hơn ba mươi năm để nuôi các con ăn học, giờ các con đã trưởng thành và có công việc ổn định, khuyên cụ nghỉ ngơi nhưng cụ vẫn muốn tiếp tục bán hàng vì đã quen với công việc, hơn nữa cụ thấy mình còn khoẻ, ngồi ở nhà mới thấy buồn chán.\n\nNghe câu chuyện ấy, Nghĩa cảm thấy vô cùng khâm phục nghị lực và tình yêu lao động của cụ già. Từ đó, mỗi lần mua bánh mì, Nghĩa đều lễ phép chào hỏi cụ và đôi khi nán lại trò chuyện đôi câu. Nghĩa nhận ra rằng, dù công việc giản dị đến đâu, nếu được làm với sự cần cù và tình yêu, nó vẫn mang lại ý nghĩa và niềm vui to lớn cho con người.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
  {
    id: "dh-passage-25",
    title: "Vì sao có sấm sét",
    text: "Vào những cơn mưa giông, chúng ta thường thấy những tia chớp sáng loé trên bầu trời, sau đó vài giây mới nghe thấy tiếng sấm ầm ầm. Hiện tượng này xảy ra là do bên trong những đám mây giông có sự va chạm mạnh giữa các hạt nước, hạt băng nhỏ, tạo ra một lượng điện tích rất lớn.\n\nKhi lượng điện tích tích tụ đủ lớn, nó sẽ phóng ra ngoài không khí dưới dạng một tia sáng chói loà mà chúng ta gọi là sét, đôi khi phóng giữa các đám mây với nhau, đôi khi phóng thẳng xuống mặt đất. Luồng điện cực mạnh này khiến không khí xung quanh bị nung nóng đột ngột lên đến hàng nghìn độ, giãn nở cực nhanh và tạo ra tiếng nổ lớn mà ta gọi là sấm.\n\nSở dĩ chúng ta luôn nhìn thấy chớp trước rồi mới nghe thấy sấm là vì ánh sáng truyền đi nhanh hơn âm thanh rất nhiều lần. Dựa vào khoảng thời gian giữa lúc thấy chớp và nghe thấy sấm, người ta có thể ước tính được khoảng cách từ nơi mình đứng đến chỗ sét đánh: cứ khoảng ba giây tương ứng với một ki-lô-mét. Vì sét có thể gây nguy hiểm, các em nên tránh đứng dưới cây cao hoặc cầm đồ vật kim loại khi trời có giông sét.",
    sourceType: "original",
    sourceNote: "Tự biên soạn (Mục 10.1 hướng B).",
  },
];
