...
- **Văn bản đọc hiểu dài kèm 5–7 câu hỏi: 5/25** (khác với 6 chuyên đề kỹ
  ...
  thử) qua component dùng chung `ReadingPassage`. 5 văn bản đã có: "Chiếc ô
  của bà Tư", "Chiếc diều đứt dây", "Chú chim sẻ non" (truyện), "Vì sao lá
  cây có màu xanh" (văn bản thông tin), "Món quà đặc biệt" (truyện) — mỗi
  câu hỏi gắn đúng kỹ năng DH-0X đang kiểm tra, không dồn vào 1 chuyên đề.
  Còn thiếu 20 văn bản.
